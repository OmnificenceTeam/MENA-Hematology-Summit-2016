...
<body class="Bg_trnsprnt">
    ...
    <div class="cols">
        <nav class="home-city-nav cursor_Pntr" onclick="Onclickviewwebcast()"> 
            <a class="choose scroll-to  custom-choose cursor_Pntr" data-offset="45" data-target="#city-nav-wrap"  runat="server" style="cursor:pointer;"><span class="uline"> VIEW WEBCAST </span></a><%-- href="#"--%><%--id="wbLink"--%>
        </nav>
    </div>
    <br />
    <br />
                ...
                <div class="bg-white">
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <a href="assets/pdf/MENA_HS_webcast1.pdf" target="_blank" class="btn btn-block bg-red"><span style="color:white;"><img src="assets/images/pdf.png" style="margin-right:5px;width:20px;"/>Click here to download agenda</span></a>
